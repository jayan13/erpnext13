...
def execute():
	...
	sle_gle_reposting_start_date = '2022-01-01'
	...
	data = frappe.db.sql('''
		...
		WHERE
			creation > '{0}'
			and is_cancelled = 0 and company='{1}'
		ORDER BY timestamp(posting_date, posting_time) asc, creation asc
	'''.format(reposting_project_deployed_on,company),as_dict=1)
...
def enqueue_reposting_sle_gle():
	#sle_gle_reposting_start_date = '2022-08-01'
	...
	print("Reposting of SLE and GLE started")
	execute()
